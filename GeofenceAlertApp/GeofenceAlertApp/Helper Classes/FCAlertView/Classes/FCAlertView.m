...
- (id)init
{
    ...
    if (self) {
        ...
        _flatTurquoise = [UIColor redColor];
        _flatGreen = [UIColor colorWithRed:39.0/255.0f green:174.0/255.0f blue:96.0/255.0f alpha:1.0];//[UIColor greenColor];
        _flatBlue = [UIColor redColor];
        _flatMidnight = [UIColor redColor];
        _flatPurple = [UIColor redColor];
        _flatOrange = [UIColor redColor];
        _flatRed = [UIColor redColor];
        _flatSilver = [UIColor redColor];
        _flatGray = [UIColor redColor];
        ...
        _customImageScale = 1;
        _titleFont = [UIFont fontWithName:CGRegular size:18];
        _subtitleFont = nil;
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_subtitleFont != nil)
        ...
        descriptionLabel.font = [UIFont fontWithName:CGRegular size:15.0];
    else
        descriptionLabel.font = [UIFont fontWithName:CGRegular size:16.0];
    ...
    if (_numberOfButtons == 0) { // View only contains DONE/DISMISS Button
        ...
        doneButton.titleLabel.font = [UIFont fontWithName:CGRegular size:18.0];
        ...
        [doneButton addTarget:self action:@selector(btnTouched) forControlEvents:UIControlEventTouchDown];
        [doneButton addTarget:self action:@selector(btnReleased) forControlEvents:UIControlEventTouchDragExit];
        doneButton.titleLabel.font = [UIFont fontWithName:CGRegular size:16.0];
        if (self.doneButtonCustomFont)
            doneButton.titleLabel.font = self.doneButtonCustomFont;
        if (_colorScheme != nil || _darkTheme)
            doneButton.tintColor = [UIColor whiteColor];
        ...
        otherButton.titleLabel.font = [UIFont fontWithName:CGRegular size:16.0];
        ...
        firstButton.titleLabel.font = [UIFont fontWithName:CGRegular size:16.0];
        if (self.firstButtonCustomFont)
        ...
        secondButton.titleLabel.font = [UIFont fontWithName:CGRegular size:16.0];
...
- (void) makeAlertTypeAdding
{
    vectorImage = [self loadImageFromResourceBundle:@"adding.png"];
    alertViewWithVector = 1;
    self.colorScheme = self.flatGreen;
//    self.colorScheme = [UIColor greenColor];
...
- (void) makeAlertTypeDanger
{
    vectorImage = [self loadImageFromResourceBundle:@"close-round.png"];
    alertViewWithVector = 1;
    self.colorScheme = [UIColor redColor];
    alertType = @"Warning";
}
...
- (void) showAlertView {
    ...
    [UIView animateWithDuration:0.3 delay:0.0 options:UIViewAnimationOptionCurveEaseOut animations:^{
        ...
        self->_alertPopSize = self->alertViewContents.frame.origin.y;
        NSLog(@"AlertView=%@",self->alertViewContents);
